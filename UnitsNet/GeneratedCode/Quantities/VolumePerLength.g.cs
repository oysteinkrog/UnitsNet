...
namespace UnitsNet
{
    ...
    public partial struct VolumePerLength : IQuantity<VolumePerLengthUnit>, IEquatable<VolumePerLength>, IComparable, IComparable<VolumePerLength>, IConvertible, IFormattable
    {
        ...
        /// </summary>
        [Obsolete("QuantityType will be removed in the future. Use the Info property instead.")]
        public QuantityType Type => QuantityType.VolumePerLength;
        ...
        internal static void RegisterDefaultConversions(UnitConverter unitConverter)
        {
            // Register in unit converter: VolumePerLengthUnit -> BaseUnit
                    unitConverter.SetConversionFunction<VolumePerLength>(VolumePerLengthUnit.CubicMeterPerMeter, VolumePerLengthUnit.CubicYardPerFoot, quantity => (quantity / 2.50838208, VolumePerLengthUnit.CubicYardPerFoot));
                    unitConverter.SetConversionFunction<VolumePerLength>(VolumePerLengthUnit.CubicMeterPerMeter, VolumePerLengthUnit.CubicYardPerUsSurveyFoot, quantity => (quantity / 2.50837706323584, VolumePerLengthUnit.CubicYardPerUsSurveyFoot));
                    unitConverter.SetConversionFunction<VolumePerLength>(VolumePerLengthUnit.CubicMeterPerMeter, VolumePerLengthUnit.LiterPerKilometer, quantity => (quantity * 1e6, VolumePerLengthUnit.LiterPerKilometer));
                    unitConverter.SetConversionFunction<VolumePerLength>(VolumePerLengthUnit.CubicMeterPerMeter, VolumePerLengthUnit.LiterPerMeter, quantity => (quantity * 1000, VolumePerLengthUnit.LiterPerMeter));
                    unitConverter.SetConversionFunction<VolumePerLength>(VolumePerLengthUnit.CubicMeterPerMeter, VolumePerLengthUnit.LiterPerMillimeter, quantity => (quantity, VolumePerLengthUnit.LiterPerMillimeter));
                    unitConverter.SetConversionFunction<VolumePerLength>(VolumePerLengthUnit.CubicMeterPerMeter, VolumePerLengthUnit.OilBarrelPerFoot, quantity => (quantity * 1.91713408, VolumePerLengthUnit.OilBarrelPerFoot));

            // Register in unit converter: BaseUnit <-> BaseUnit
            unitConverter.SetConversionFunction<VolumePerLength>(VolumePerLengthUnit.CubicMeterPerMeter, VolumePerLengthUnit.CubicMeterPerMeter, quantity => (quantity, VolumePerLengthUnit.CubicMeterPerMeter));

            // Register in unit converter: BaseUnit -> VolumePerLengthUnit
                    unitConverter.SetConversionFunction<VolumePerLength>(VolumePerLengthUnit.CubicYardPerFoot, VolumePerLengthUnit.CubicMeterPerMeter, quantity => (quantity / 2.50838208, VolumePerLengthUnit.CubicMeterPerMeter));
                    unitConverter.SetConversionFunction<VolumePerLength>(VolumePerLengthUnit.CubicYardPerUsSurveyFoot, VolumePerLengthUnit.CubicMeterPerMeter, quantity => (quantity / 2.50837706323584, VolumePerLengthUnit.CubicMeterPerMeter));
                    unitConverter.SetConversionFunction<VolumePerLength>(VolumePerLengthUnit.LiterPerKilometer, VolumePerLengthUnit.CubicMeterPerMeter, quantity => (quantity * 1e6, VolumePerLengthUnit.CubicMeterPerMeter));
                    unitConverter.SetConversionFunction<VolumePerLength>(VolumePerLengthUnit.LiterPerMeter, VolumePerLengthUnit.CubicMeterPerMeter, quantity => (quantity * 1000, VolumePerLengthUnit.CubicMeterPerMeter));
                    unitConverter.SetConversionFunction<VolumePerLength>(VolumePerLengthUnit.LiterPerMillimeter, VolumePerLengthUnit.CubicMeterPerMeter, quantity => (quantity, VolumePerLengthUnit.CubicMeterPerMeter));
                    unitConverter.SetConversionFunction<VolumePerLength>(VolumePerLengthUnit.OilBarrelPerFoot, VolumePerLengthUnit.CubicMeterPerMeter, quantity => (quantity * 1.91713408, VolumePerLengthUnit.CubicMeterPerMeter));
        }
        ...
        public VolumePerLength ToUnit(VolumePerLengthUnit unit, UnitConverter unitConverter)
        {
            ...
            else if (unitConverter.TryGetConversionFunction<VolumePerLength>(Unit, unit, out ConversionFunctionSameTypeDecimal conversionFunction))
            {
                // Direct conversion to requested unit found. Return the converted quantity.
                var c = conversionFunction(this.Value);
                return new VolumePerLength(c.Item1, (VolumePerLengthUnit)c.Item2);
            }
