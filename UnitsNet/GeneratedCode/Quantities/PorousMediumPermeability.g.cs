...
namespace UnitsNet
{
    ...
    /// </remarks>
    [DataContract]
    public partial struct PorousMediumPermeability : IQuantity<PorousMediumPermeabilityUnit>, IEquatable<PorousMediumPermeability>, IComparable, IComparable<PorousMediumPermeability>, IConvertible, IFormattable
    {
        /// <summary>
        ...
        static PorousMediumPermeability()
        {
            ...
            MaxValue = new PorousMediumPermeability(double.MaxValue, BaseUnit);
            MinValue = new PorousMediumPermeability(double.MinValue, BaseUnit);
            QuantityType = QuantityType.PorousMediumPermeability;
            Units = Enum.GetValues(typeof(PorousMediumPermeabilityUnit)).Cast<PorousMediumPermeabilityUnit>().Except(new PorousMediumPermeabilityUnit[]{ PorousMediumPermeabilityUnit.Undefined }).ToArray();
            ...
            Info = new QuantityInfo<PorousMediumPermeabilityUnit>("PorousMediumPermeability",
                ...
                BaseUnit, Zero, BaseDimensions, QuantityType.PorousMediumPermeability);
        ...
        public static PorousMediumPermeability MaxValue { get; }

        /// <summary>
        /// Represents the smallest possible value of PorousMediumPermeability
        /// </summary>
        [Obsolete("MaxValue and MinValue will be removed. Choose your own value or use nullability for unbounded lower/upper range checks. See discussion in https://github.com/angularsen/UnitsNet/issues/848.")]
        public static PorousMediumPermeability MinValue { get; }
        ...
        /// </summary>
        [Obsolete("QuantityType will be removed in the future. Use the Info property instead.")]
        public QuantityType Type => QuantityType.PorousMediumPermeability;
        ...
        /// <remarks>Consider using <see cref="Equals(PorousMediumPermeability, double, ComparisonType)"/> for safely comparing floating point values.</remarks>
        public static bool operator ==(PorousMediumPermeability left, PorousMediumPermeability right)
        {
        ...
        public int CompareTo(object obj)
        {
            ...
            if (!(obj is PorousMediumPermeability objPorousMediumPermeability)) throw new ArgumentException("Expected type PorousMediumPermeability.", nameof(obj));

            return CompareTo(objPorousMediumPermeability);
        }
        ...
        {
            if (obj is null || !(obj is PorousMediumPermeability objPorousMediumPermeability))
                return false;

            return Equals(objPorousMediumPermeability);
        }
        ...
        {
            if (!(unit is PorousMediumPermeabilityUnit unitAsPorousMediumPermeabilityUnit))
            ...
            return As(unitAsPorousMediumPermeabilityUnit);
        }
        ...
        IQuantity IQuantity.ToUnit(Enum unit)
        {
            ...
            return ToUnit(unitAsPorousMediumPermeabilityUnit, DefaultConversionFunctions);
        }
        ...
        object IConvertible.ToType(Type conversionType, IFormatProvider provider)
        {
            if (conversionType == typeof(PorousMediumPermeability))
                ...
                return PorousMediumPermeability.QuantityType;
