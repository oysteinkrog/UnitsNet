    ...
    public partial struct MassConcentration : IQuantity<MassConcentrationUnit>, IEquatable<MassConcentration>, IComparable, IComparable<MassConcentration>, IConvertible, IFormattable
    {
        ...
        internal static void RegisterDefaultConversions(UnitConverter unitConverter)
        {
            // Register in unit converter: MassConcentrationUnit -> BaseUnit
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.KilogramPerCubicMeter, MassConcentrationUnit.CentigramPerDeciliter, quantity => ((quantity * 1e-1) / 1e-2d, MassConcentrationUnit.CentigramPerDeciliter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.KilogramPerCubicMeter, MassConcentrationUnit.CentigramPerLiter, quantity => ((quantity) / 1e-2d, MassConcentrationUnit.CentigramPerLiter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.KilogramPerCubicMeter, MassConcentrationUnit.CentigramPerMicroliter, quantity => ((quantity * 1e-6) / 1e-2d, MassConcentrationUnit.CentigramPerMicroliter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.KilogramPerCubicMeter, MassConcentrationUnit.CentigramPerMilliliter, quantity => ((quantity * 1e-3) / 1e-2d, MassConcentrationUnit.CentigramPerMilliliter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.KilogramPerCubicMeter, MassConcentrationUnit.DecigramPerDeciliter, quantity => ((quantity * 1e-1) / 1e-1d, MassConcentrationUnit.DecigramPerDeciliter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.KilogramPerCubicMeter, MassConcentrationUnit.DecigramPerLiter, quantity => ((quantity) / 1e-1d, MassConcentrationUnit.DecigramPerLiter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.KilogramPerCubicMeter, MassConcentrationUnit.DecigramPerMicroliter, quantity => ((quantity * 1e-6) / 1e-1d, MassConcentrationUnit.DecigramPerMicroliter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.KilogramPerCubicMeter, MassConcentrationUnit.DecigramPerMilliliter, quantity => ((quantity * 1e-3) / 1e-1d, MassConcentrationUnit.DecigramPerMilliliter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.KilogramPerCubicMeter, MassConcentrationUnit.GramPerCubicCentimeter, quantity => (quantity * 1e-3, MassConcentrationUnit.GramPerCubicCentimeter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.KilogramPerCubicMeter, MassConcentrationUnit.GramPerCubicMeter, quantity => (quantity * 1e3, MassConcentrationUnit.GramPerCubicMeter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.KilogramPerCubicMeter, MassConcentrationUnit.GramPerCubicMillimeter, quantity => (quantity * 1e-6, MassConcentrationUnit.GramPerCubicMillimeter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.KilogramPerCubicMeter, MassConcentrationUnit.GramPerDeciliter, quantity => (quantity * 1e-1, MassConcentrationUnit.GramPerDeciliter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.KilogramPerCubicMeter, MassConcentrationUnit.GramPerLiter, quantity => (quantity, MassConcentrationUnit.GramPerLiter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.KilogramPerCubicMeter, MassConcentrationUnit.GramPerMicroliter, quantity => (quantity * 1e-6, MassConcentrationUnit.GramPerMicroliter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.KilogramPerCubicMeter, MassConcentrationUnit.GramPerMilliliter, quantity => (quantity * 1e-3, MassConcentrationUnit.GramPerMilliliter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.KilogramPerCubicMeter, MassConcentrationUnit.KilogramPerCubicCentimeter, quantity => ((quantity * 1e-3) / 1e3d, MassConcentrationUnit.KilogramPerCubicCentimeter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.KilogramPerCubicMeter, MassConcentrationUnit.KilogramPerCubicMillimeter, quantity => ((quantity * 1e-6) / 1e3d, MassConcentrationUnit.KilogramPerCubicMillimeter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.KilogramPerCubicMeter, MassConcentrationUnit.KilogramPerLiter, quantity => ((quantity) / 1e3d, MassConcentrationUnit.KilogramPerLiter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.KilogramPerCubicMeter, MassConcentrationUnit.KilopoundPerCubicFoot, quantity => ((quantity * 0.062427961) / 1e3d, MassConcentrationUnit.KilopoundPerCubicFoot));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.KilogramPerCubicMeter, MassConcentrationUnit.KilopoundPerCubicInch, quantity => ((quantity * 3.6127298147753e-5) / 1e3d, MassConcentrationUnit.KilopoundPerCubicInch));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.KilogramPerCubicMeter, MassConcentrationUnit.MicrogramPerCubicMeter, quantity => ((quantity * 1e3) / 1e-6d, MassConcentrationUnit.MicrogramPerCubicMeter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.KilogramPerCubicMeter, MassConcentrationUnit.MicrogramPerDeciliter, quantity => ((quantity * 1e-1) / 1e-6d, MassConcentrationUnit.MicrogramPerDeciliter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.KilogramPerCubicMeter, MassConcentrationUnit.MicrogramPerLiter, quantity => ((quantity) / 1e-6d, MassConcentrationUnit.MicrogramPerLiter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.KilogramPerCubicMeter, MassConcentrationUnit.MicrogramPerMicroliter, quantity => ((quantity * 1e-6) / 1e-6d, MassConcentrationUnit.MicrogramPerMicroliter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.KilogramPerCubicMeter, MassConcentrationUnit.MicrogramPerMilliliter, quantity => ((quantity * 1e-3) / 1e-6d, MassConcentrationUnit.MicrogramPerMilliliter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.KilogramPerCubicMeter, MassConcentrationUnit.MilligramPerCubicMeter, quantity => ((quantity * 1e3) / 1e-3d, MassConcentrationUnit.MilligramPerCubicMeter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.KilogramPerCubicMeter, MassConcentrationUnit.MilligramPerDeciliter, quantity => ((quantity * 1e-1) / 1e-3d, MassConcentrationUnit.MilligramPerDeciliter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.KilogramPerCubicMeter, MassConcentrationUnit.MilligramPerLiter, quantity => ((quantity) / 1e-3d, MassConcentrationUnit.MilligramPerLiter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.KilogramPerCubicMeter, MassConcentrationUnit.MilligramPerMicroliter, quantity => ((quantity * 1e-6) / 1e-3d, MassConcentrationUnit.MilligramPerMicroliter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.KilogramPerCubicMeter, MassConcentrationUnit.MilligramPerMilliliter, quantity => ((quantity * 1e-3) / 1e-3d, MassConcentrationUnit.MilligramPerMilliliter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.KilogramPerCubicMeter, MassConcentrationUnit.NanogramPerDeciliter, quantity => ((quantity * 1e-1) / 1e-9d, MassConcentrationUnit.NanogramPerDeciliter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.KilogramPerCubicMeter, MassConcentrationUnit.NanogramPerLiter, quantity => ((quantity) / 1e-9d, MassConcentrationUnit.NanogramPerLiter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.KilogramPerCubicMeter, MassConcentrationUnit.NanogramPerMicroliter, quantity => ((quantity * 1e-6) / 1e-9d, MassConcentrationUnit.NanogramPerMicroliter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.KilogramPerCubicMeter, MassConcentrationUnit.NanogramPerMilliliter, quantity => ((quantity * 1e-3) / 1e-9d, MassConcentrationUnit.NanogramPerMilliliter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.KilogramPerCubicMeter, MassConcentrationUnit.OuncePerImperialGallon, quantity => (quantity * 0.1603586720609, MassConcentrationUnit.OuncePerImperialGallon));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.KilogramPerCubicMeter, MassConcentrationUnit.OuncePerUSGallon, quantity => (quantity * 0.1335264711843, MassConcentrationUnit.OuncePerUSGallon));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.KilogramPerCubicMeter, MassConcentrationUnit.PicogramPerDeciliter, quantity => ((quantity * 1e-1) / 1e-12d, MassConcentrationUnit.PicogramPerDeciliter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.KilogramPerCubicMeter, MassConcentrationUnit.PicogramPerLiter, quantity => ((quantity) / 1e-12d, MassConcentrationUnit.PicogramPerLiter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.KilogramPerCubicMeter, MassConcentrationUnit.PicogramPerMicroliter, quantity => ((quantity * 1e-6) / 1e-12d, MassConcentrationUnit.PicogramPerMicroliter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.KilogramPerCubicMeter, MassConcentrationUnit.PicogramPerMilliliter, quantity => ((quantity * 1e-3) / 1e-12d, MassConcentrationUnit.PicogramPerMilliliter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.KilogramPerCubicMeter, MassConcentrationUnit.PoundPerCubicFoot, quantity => (quantity * 0.062427961, MassConcentrationUnit.PoundPerCubicFoot));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.KilogramPerCubicMeter, MassConcentrationUnit.PoundPerCubicInch, quantity => (quantity * 3.6127298147753e-5, MassConcentrationUnit.PoundPerCubicInch));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.KilogramPerCubicMeter, MassConcentrationUnit.PoundPerImperialGallon, quantity => (quantity / 9.9776398e1, MassConcentrationUnit.PoundPerImperialGallon));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.KilogramPerCubicMeter, MassConcentrationUnit.PoundPerUSGallon, quantity => (quantity / 1.19826427e2, MassConcentrationUnit.PoundPerUSGallon));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.KilogramPerCubicMeter, MassConcentrationUnit.SlugPerCubicFoot, quantity => (quantity * 0.00194032033, MassConcentrationUnit.SlugPerCubicFoot));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.KilogramPerCubicMeter, MassConcentrationUnit.TonnePerCubicCentimeter, quantity => (quantity * 1e-9, MassConcentrationUnit.TonnePerCubicCentimeter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.KilogramPerCubicMeter, MassConcentrationUnit.TonnePerCubicMeter, quantity => (quantity * 0.001, MassConcentrationUnit.TonnePerCubicMeter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.KilogramPerCubicMeter, MassConcentrationUnit.TonnePerCubicMillimeter, quantity => (quantity * 1e-12, MassConcentrationUnit.TonnePerCubicMillimeter));

            // Register in unit converter: BaseUnit <-> BaseUnit
            unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.KilogramPerCubicMeter, MassConcentrationUnit.KilogramPerCubicMeter, quantity => (quantity, MassConcentrationUnit.KilogramPerCubicMeter));

            // Register in unit converter: BaseUnit -> MassConcentrationUnit
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.CentigramPerDeciliter, MassConcentrationUnit.KilogramPerCubicMeter, quantity => ((quantity * 1e-1) / 1e-2d, MassConcentrationUnit.KilogramPerCubicMeter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.CentigramPerLiter, MassConcentrationUnit.KilogramPerCubicMeter, quantity => ((quantity) / 1e-2d, MassConcentrationUnit.KilogramPerCubicMeter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.CentigramPerMicroliter, MassConcentrationUnit.KilogramPerCubicMeter, quantity => ((quantity * 1e-6) / 1e-2d, MassConcentrationUnit.KilogramPerCubicMeter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.CentigramPerMilliliter, MassConcentrationUnit.KilogramPerCubicMeter, quantity => ((quantity * 1e-3) / 1e-2d, MassConcentrationUnit.KilogramPerCubicMeter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.DecigramPerDeciliter, MassConcentrationUnit.KilogramPerCubicMeter, quantity => ((quantity * 1e-1) / 1e-1d, MassConcentrationUnit.KilogramPerCubicMeter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.DecigramPerLiter, MassConcentrationUnit.KilogramPerCubicMeter, quantity => ((quantity) / 1e-1d, MassConcentrationUnit.KilogramPerCubicMeter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.DecigramPerMicroliter, MassConcentrationUnit.KilogramPerCubicMeter, quantity => ((quantity * 1e-6) / 1e-1d, MassConcentrationUnit.KilogramPerCubicMeter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.DecigramPerMilliliter, MassConcentrationUnit.KilogramPerCubicMeter, quantity => ((quantity * 1e-3) / 1e-1d, MassConcentrationUnit.KilogramPerCubicMeter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.GramPerCubicCentimeter, MassConcentrationUnit.KilogramPerCubicMeter, quantity => (quantity * 1e-3, MassConcentrationUnit.KilogramPerCubicMeter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.GramPerCubicMeter, MassConcentrationUnit.KilogramPerCubicMeter, quantity => (quantity * 1e3, MassConcentrationUnit.KilogramPerCubicMeter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.GramPerCubicMillimeter, MassConcentrationUnit.KilogramPerCubicMeter, quantity => (quantity * 1e-6, MassConcentrationUnit.KilogramPerCubicMeter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.GramPerDeciliter, MassConcentrationUnit.KilogramPerCubicMeter, quantity => (quantity * 1e-1, MassConcentrationUnit.KilogramPerCubicMeter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.GramPerLiter, MassConcentrationUnit.KilogramPerCubicMeter, quantity => (quantity, MassConcentrationUnit.KilogramPerCubicMeter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.GramPerMicroliter, MassConcentrationUnit.KilogramPerCubicMeter, quantity => (quantity * 1e-6, MassConcentrationUnit.KilogramPerCubicMeter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.GramPerMilliliter, MassConcentrationUnit.KilogramPerCubicMeter, quantity => (quantity * 1e-3, MassConcentrationUnit.KilogramPerCubicMeter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.KilogramPerCubicCentimeter, MassConcentrationUnit.KilogramPerCubicMeter, quantity => ((quantity * 1e-3) / 1e3d, MassConcentrationUnit.KilogramPerCubicMeter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.KilogramPerCubicMillimeter, MassConcentrationUnit.KilogramPerCubicMeter, quantity => ((quantity * 1e-6) / 1e3d, MassConcentrationUnit.KilogramPerCubicMeter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.KilogramPerLiter, MassConcentrationUnit.KilogramPerCubicMeter, quantity => ((quantity) / 1e3d, MassConcentrationUnit.KilogramPerCubicMeter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.KilopoundPerCubicFoot, MassConcentrationUnit.KilogramPerCubicMeter, quantity => ((quantity * 0.062427961) / 1e3d, MassConcentrationUnit.KilogramPerCubicMeter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.KilopoundPerCubicInch, MassConcentrationUnit.KilogramPerCubicMeter, quantity => ((quantity * 3.6127298147753e-5) / 1e3d, MassConcentrationUnit.KilogramPerCubicMeter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.MicrogramPerCubicMeter, MassConcentrationUnit.KilogramPerCubicMeter, quantity => ((quantity * 1e3) / 1e-6d, MassConcentrationUnit.KilogramPerCubicMeter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.MicrogramPerDeciliter, MassConcentrationUnit.KilogramPerCubicMeter, quantity => ((quantity * 1e-1) / 1e-6d, MassConcentrationUnit.KilogramPerCubicMeter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.MicrogramPerLiter, MassConcentrationUnit.KilogramPerCubicMeter, quantity => ((quantity) / 1e-6d, MassConcentrationUnit.KilogramPerCubicMeter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.MicrogramPerMicroliter, MassConcentrationUnit.KilogramPerCubicMeter, quantity => ((quantity * 1e-6) / 1e-6d, MassConcentrationUnit.KilogramPerCubicMeter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.MicrogramPerMilliliter, MassConcentrationUnit.KilogramPerCubicMeter, quantity => ((quantity * 1e-3) / 1e-6d, MassConcentrationUnit.KilogramPerCubicMeter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.MilligramPerCubicMeter, MassConcentrationUnit.KilogramPerCubicMeter, quantity => ((quantity * 1e3) / 1e-3d, MassConcentrationUnit.KilogramPerCubicMeter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.MilligramPerDeciliter, MassConcentrationUnit.KilogramPerCubicMeter, quantity => ((quantity * 1e-1) / 1e-3d, MassConcentrationUnit.KilogramPerCubicMeter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.MilligramPerLiter, MassConcentrationUnit.KilogramPerCubicMeter, quantity => ((quantity) / 1e-3d, MassConcentrationUnit.KilogramPerCubicMeter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.MilligramPerMicroliter, MassConcentrationUnit.KilogramPerCubicMeter, quantity => ((quantity * 1e-6) / 1e-3d, MassConcentrationUnit.KilogramPerCubicMeter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.MilligramPerMilliliter, MassConcentrationUnit.KilogramPerCubicMeter, quantity => ((quantity * 1e-3) / 1e-3d, MassConcentrationUnit.KilogramPerCubicMeter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.NanogramPerDeciliter, MassConcentrationUnit.KilogramPerCubicMeter, quantity => ((quantity * 1e-1) / 1e-9d, MassConcentrationUnit.KilogramPerCubicMeter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.NanogramPerLiter, MassConcentrationUnit.KilogramPerCubicMeter, quantity => ((quantity) / 1e-9d, MassConcentrationUnit.KilogramPerCubicMeter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.NanogramPerMicroliter, MassConcentrationUnit.KilogramPerCubicMeter, quantity => ((quantity * 1e-6) / 1e-9d, MassConcentrationUnit.KilogramPerCubicMeter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.NanogramPerMilliliter, MassConcentrationUnit.KilogramPerCubicMeter, quantity => ((quantity * 1e-3) / 1e-9d, MassConcentrationUnit.KilogramPerCubicMeter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.OuncePerImperialGallon, MassConcentrationUnit.KilogramPerCubicMeter, quantity => (quantity * 0.1603586720609, MassConcentrationUnit.KilogramPerCubicMeter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.OuncePerUSGallon, MassConcentrationUnit.KilogramPerCubicMeter, quantity => (quantity * 0.1335264711843, MassConcentrationUnit.KilogramPerCubicMeter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.PicogramPerDeciliter, MassConcentrationUnit.KilogramPerCubicMeter, quantity => ((quantity * 1e-1) / 1e-12d, MassConcentrationUnit.KilogramPerCubicMeter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.PicogramPerLiter, MassConcentrationUnit.KilogramPerCubicMeter, quantity => ((quantity) / 1e-12d, MassConcentrationUnit.KilogramPerCubicMeter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.PicogramPerMicroliter, MassConcentrationUnit.KilogramPerCubicMeter, quantity => ((quantity * 1e-6) / 1e-12d, MassConcentrationUnit.KilogramPerCubicMeter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.PicogramPerMilliliter, MassConcentrationUnit.KilogramPerCubicMeter, quantity => ((quantity * 1e-3) / 1e-12d, MassConcentrationUnit.KilogramPerCubicMeter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.PoundPerCubicFoot, MassConcentrationUnit.KilogramPerCubicMeter, quantity => (quantity * 0.062427961, MassConcentrationUnit.KilogramPerCubicMeter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.PoundPerCubicInch, MassConcentrationUnit.KilogramPerCubicMeter, quantity => (quantity * 3.6127298147753e-5, MassConcentrationUnit.KilogramPerCubicMeter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.PoundPerImperialGallon, MassConcentrationUnit.KilogramPerCubicMeter, quantity => (quantity / 9.9776398e1, MassConcentrationUnit.KilogramPerCubicMeter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.PoundPerUSGallon, MassConcentrationUnit.KilogramPerCubicMeter, quantity => (quantity / 1.19826427e2, MassConcentrationUnit.KilogramPerCubicMeter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.SlugPerCubicFoot, MassConcentrationUnit.KilogramPerCubicMeter, quantity => (quantity * 0.00194032033, MassConcentrationUnit.KilogramPerCubicMeter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.TonnePerCubicCentimeter, MassConcentrationUnit.KilogramPerCubicMeter, quantity => (quantity * 1e-9, MassConcentrationUnit.KilogramPerCubicMeter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.TonnePerCubicMeter, MassConcentrationUnit.KilogramPerCubicMeter, quantity => (quantity * 0.001, MassConcentrationUnit.KilogramPerCubicMeter));
                    unitConverter.SetConversionFunction<MassConcentration>(MassConcentrationUnit.TonnePerCubicMillimeter, MassConcentrationUnit.KilogramPerCubicMeter, quantity => (quantity * 1e-12, MassConcentrationUnit.KilogramPerCubicMeter));
        }
        ...
        public MassConcentration ToUnit(MassConcentrationUnit unit, UnitConverter unitConverter)
        {
            ...
            else if (unitConverter.TryGetConversionFunction<MassConcentration>(Unit, unit, out ConversionFunctionSameTypeDecimal conversionFunction))
            {
                // Direct conversion to requested unit found. Return the converted quantity.
                var c = conversionFunction(this.Value);
                return new MassConcentration(c.Item1, (MassConcentrationUnit)c.Item2);
            }
