...
namespace UnitsNet
{
    ...
    public partial struct LapseRate : IQuantity<LapseRateUnit>, IEquatable<LapseRate>, IComparable, IComparable<LapseRate>, IConvertible, IFormattable
    {
        ...
        /// <summary>
        ///     Converts this <see cref="LapseRate"/> to another <see cref="LapseRate"/> using the given <paramref name="unitConverter"/> with the unit representation <paramref name="unit" />.
        /// </summary>
        /// <param name="unit">The unit to convert to.</param>
        ...
        /// <summary>
        ///     Attempts to convert this <see cref="LapseRate"/> to another <see cref="LapseRate"/> with the unit representation <paramref name="unit" />.
        /// </summary>
        /// <param name="unit">The unit to convert to.</param>
        /// <param name="converted">The converted <see cref="LapseRate"/> in <paramref name="unit"/>, if successful.</param>
        /// <returns>True if successful, otherwise false.</returns>
