    ...
    public partial struct MassMomentOfInertia : IQuantity<MassMomentOfInertiaUnit>, IEquatable<MassMomentOfInertia>, IComparable, IComparable<MassMomentOfInertia>, IConvertible, IFormattable
    {
        ...
        internal static void RegisterDefaultConversions(UnitConverter unitConverter)
        {
            // Register in unit converter: MassMomentOfInertiaUnit -> BaseUnit
                    unitConverter.SetConversionFunction<MassMomentOfInertia>(MassMomentOfInertiaUnit.KilogramSquareMeter, MassMomentOfInertiaUnit.GramSquareCentimeter, quantity => (quantity * 1e7, MassMomentOfInertiaUnit.GramSquareCentimeter));
                    unitConverter.SetConversionFunction<MassMomentOfInertia>(MassMomentOfInertiaUnit.KilogramSquareMeter, MassMomentOfInertiaUnit.GramSquareDecimeter, quantity => (quantity * 1e5, MassMomentOfInertiaUnit.GramSquareDecimeter));
                    unitConverter.SetConversionFunction<MassMomentOfInertia>(MassMomentOfInertiaUnit.KilogramSquareMeter, MassMomentOfInertiaUnit.GramSquareMeter, quantity => (quantity * 1e3, MassMomentOfInertiaUnit.GramSquareMeter));
                    unitConverter.SetConversionFunction<MassMomentOfInertia>(MassMomentOfInertiaUnit.KilogramSquareMeter, MassMomentOfInertiaUnit.GramSquareMillimeter, quantity => (quantity * 1e9, MassMomentOfInertiaUnit.GramSquareMillimeter));
                    unitConverter.SetConversionFunction<MassMomentOfInertia>(MassMomentOfInertiaUnit.KilogramSquareMeter, MassMomentOfInertiaUnit.KilogramSquareCentimeter, quantity => ((quantity * 1e7) / 1e3d, MassMomentOfInertiaUnit.KilogramSquareCentimeter));
                    unitConverter.SetConversionFunction<MassMomentOfInertia>(MassMomentOfInertiaUnit.KilogramSquareMeter, MassMomentOfInertiaUnit.KilogramSquareDecimeter, quantity => ((quantity * 1e5) / 1e3d, MassMomentOfInertiaUnit.KilogramSquareDecimeter));
                    unitConverter.SetConversionFunction<MassMomentOfInertia>(MassMomentOfInertiaUnit.KilogramSquareMeter, MassMomentOfInertiaUnit.KilogramSquareMillimeter, quantity => ((quantity * 1e9) / 1e3d, MassMomentOfInertiaUnit.KilogramSquareMillimeter));
                    unitConverter.SetConversionFunction<MassMomentOfInertia>(MassMomentOfInertiaUnit.KilogramSquareMeter, MassMomentOfInertiaUnit.KilotonneSquareCentimeter, quantity => ((quantity * 1e1) / 1e3d, MassMomentOfInertiaUnit.KilotonneSquareCentimeter));
                    unitConverter.SetConversionFunction<MassMomentOfInertia>(MassMomentOfInertiaUnit.KilogramSquareMeter, MassMomentOfInertiaUnit.KilotonneSquareDecimeter, quantity => ((quantity * 1e-1) / 1e3d, MassMomentOfInertiaUnit.KilotonneSquareDecimeter));
                    unitConverter.SetConversionFunction<MassMomentOfInertia>(MassMomentOfInertiaUnit.KilogramSquareMeter, MassMomentOfInertiaUnit.KilotonneSquareMeter, quantity => ((quantity * 1e-3) / 1e3d, MassMomentOfInertiaUnit.KilotonneSquareMeter));
                    unitConverter.SetConversionFunction<MassMomentOfInertia>(MassMomentOfInertiaUnit.KilogramSquareMeter, MassMomentOfInertiaUnit.KilotonneSquareMilimeter, quantity => ((quantity * 1e3) / 1e3d, MassMomentOfInertiaUnit.KilotonneSquareMilimeter));
                    unitConverter.SetConversionFunction<MassMomentOfInertia>(MassMomentOfInertiaUnit.KilogramSquareMeter, MassMomentOfInertiaUnit.MegatonneSquareCentimeter, quantity => ((quantity * 1e1) / 1e6d, MassMomentOfInertiaUnit.MegatonneSquareCentimeter));
                    unitConverter.SetConversionFunction<MassMomentOfInertia>(MassMomentOfInertiaUnit.KilogramSquareMeter, MassMomentOfInertiaUnit.MegatonneSquareDecimeter, quantity => ((quantity * 1e-1) / 1e6d, MassMomentOfInertiaUnit.MegatonneSquareDecimeter));
                    unitConverter.SetConversionFunction<MassMomentOfInertia>(MassMomentOfInertiaUnit.KilogramSquareMeter, MassMomentOfInertiaUnit.MegatonneSquareMeter, quantity => ((quantity * 1e-3) / 1e6d, MassMomentOfInertiaUnit.MegatonneSquareMeter));
                    unitConverter.SetConversionFunction<MassMomentOfInertia>(MassMomentOfInertiaUnit.KilogramSquareMeter, MassMomentOfInertiaUnit.MegatonneSquareMilimeter, quantity => ((quantity * 1e3) / 1e6d, MassMomentOfInertiaUnit.MegatonneSquareMilimeter));
                    unitConverter.SetConversionFunction<MassMomentOfInertia>(MassMomentOfInertiaUnit.KilogramSquareMeter, MassMomentOfInertiaUnit.MilligramSquareCentimeter, quantity => ((quantity * 1e7) / 1e-3d, MassMomentOfInertiaUnit.MilligramSquareCentimeter));
                    unitConverter.SetConversionFunction<MassMomentOfInertia>(MassMomentOfInertiaUnit.KilogramSquareMeter, MassMomentOfInertiaUnit.MilligramSquareDecimeter, quantity => ((quantity * 1e5) / 1e-3d, MassMomentOfInertiaUnit.MilligramSquareDecimeter));
                    unitConverter.SetConversionFunction<MassMomentOfInertia>(MassMomentOfInertiaUnit.KilogramSquareMeter, MassMomentOfInertiaUnit.MilligramSquareMeter, quantity => ((quantity * 1e3) / 1e-3d, MassMomentOfInertiaUnit.MilligramSquareMeter));
                    unitConverter.SetConversionFunction<MassMomentOfInertia>(MassMomentOfInertiaUnit.KilogramSquareMeter, MassMomentOfInertiaUnit.MilligramSquareMillimeter, quantity => ((quantity * 1e9) / 1e-3d, MassMomentOfInertiaUnit.MilligramSquareMillimeter));
                    unitConverter.SetConversionFunction<MassMomentOfInertia>(MassMomentOfInertiaUnit.KilogramSquareMeter, MassMomentOfInertiaUnit.PoundSquareFoot, quantity => (quantity / 4.21401101e-2, MassMomentOfInertiaUnit.PoundSquareFoot));
                    unitConverter.SetConversionFunction<MassMomentOfInertia>(MassMomentOfInertiaUnit.KilogramSquareMeter, MassMomentOfInertiaUnit.PoundSquareInch, quantity => (quantity / 2.9263965e-4, MassMomentOfInertiaUnit.PoundSquareInch));
                    unitConverter.SetConversionFunction<MassMomentOfInertia>(MassMomentOfInertiaUnit.KilogramSquareMeter, MassMomentOfInertiaUnit.SlugSquareFoot, quantity => (quantity / 1.3558179619, MassMomentOfInertiaUnit.SlugSquareFoot));
                    unitConverter.SetConversionFunction<MassMomentOfInertia>(MassMomentOfInertiaUnit.KilogramSquareMeter, MassMomentOfInertiaUnit.SlugSquareInch, quantity => (quantity / 9.41540242e-3, MassMomentOfInertiaUnit.SlugSquareInch));
                    unitConverter.SetConversionFunction<MassMomentOfInertia>(MassMomentOfInertiaUnit.KilogramSquareMeter, MassMomentOfInertiaUnit.TonneSquareCentimeter, quantity => (quantity * 1e1, MassMomentOfInertiaUnit.TonneSquareCentimeter));
                    unitConverter.SetConversionFunction<MassMomentOfInertia>(MassMomentOfInertiaUnit.KilogramSquareMeter, MassMomentOfInertiaUnit.TonneSquareDecimeter, quantity => (quantity * 1e-1, MassMomentOfInertiaUnit.TonneSquareDecimeter));
                    unitConverter.SetConversionFunction<MassMomentOfInertia>(MassMomentOfInertiaUnit.KilogramSquareMeter, MassMomentOfInertiaUnit.TonneSquareMeter, quantity => (quantity * 1e-3, MassMomentOfInertiaUnit.TonneSquareMeter));
                    unitConverter.SetConversionFunction<MassMomentOfInertia>(MassMomentOfInertiaUnit.KilogramSquareMeter, MassMomentOfInertiaUnit.TonneSquareMilimeter, quantity => (quantity * 1e3, MassMomentOfInertiaUnit.TonneSquareMilimeter));

            // Register in unit converter: BaseUnit <-> BaseUnit
            unitConverter.SetConversionFunction<MassMomentOfInertia>(MassMomentOfInertiaUnit.KilogramSquareMeter, MassMomentOfInertiaUnit.KilogramSquareMeter, quantity => (quantity, MassMomentOfInertiaUnit.KilogramSquareMeter));

            // Register in unit converter: BaseUnit -> MassMomentOfInertiaUnit
                    unitConverter.SetConversionFunction<MassMomentOfInertia>(MassMomentOfInertiaUnit.GramSquareCentimeter, MassMomentOfInertiaUnit.KilogramSquareMeter, quantity => (quantity * 1e7, MassMomentOfInertiaUnit.KilogramSquareMeter));
                    unitConverter.SetConversionFunction<MassMomentOfInertia>(MassMomentOfInertiaUnit.GramSquareDecimeter, MassMomentOfInertiaUnit.KilogramSquareMeter, quantity => (quantity * 1e5, MassMomentOfInertiaUnit.KilogramSquareMeter));
                    unitConverter.SetConversionFunction<MassMomentOfInertia>(MassMomentOfInertiaUnit.GramSquareMeter, MassMomentOfInertiaUnit.KilogramSquareMeter, quantity => (quantity * 1e3, MassMomentOfInertiaUnit.KilogramSquareMeter));
                    unitConverter.SetConversionFunction<MassMomentOfInertia>(MassMomentOfInertiaUnit.GramSquareMillimeter, MassMomentOfInertiaUnit.KilogramSquareMeter, quantity => (quantity * 1e9, MassMomentOfInertiaUnit.KilogramSquareMeter));
                    unitConverter.SetConversionFunction<MassMomentOfInertia>(MassMomentOfInertiaUnit.KilogramSquareCentimeter, MassMomentOfInertiaUnit.KilogramSquareMeter, quantity => ((quantity * 1e7) / 1e3d, MassMomentOfInertiaUnit.KilogramSquareMeter));
                    unitConverter.SetConversionFunction<MassMomentOfInertia>(MassMomentOfInertiaUnit.KilogramSquareDecimeter, MassMomentOfInertiaUnit.KilogramSquareMeter, quantity => ((quantity * 1e5) / 1e3d, MassMomentOfInertiaUnit.KilogramSquareMeter));
                    unitConverter.SetConversionFunction<MassMomentOfInertia>(MassMomentOfInertiaUnit.KilogramSquareMillimeter, MassMomentOfInertiaUnit.KilogramSquareMeter, quantity => ((quantity * 1e9) / 1e3d, MassMomentOfInertiaUnit.KilogramSquareMeter));
                    unitConverter.SetConversionFunction<MassMomentOfInertia>(MassMomentOfInertiaUnit.KilotonneSquareCentimeter, MassMomentOfInertiaUnit.KilogramSquareMeter, quantity => ((quantity * 1e1) / 1e3d, MassMomentOfInertiaUnit.KilogramSquareMeter));
                    unitConverter.SetConversionFunction<MassMomentOfInertia>(MassMomentOfInertiaUnit.KilotonneSquareDecimeter, MassMomentOfInertiaUnit.KilogramSquareMeter, quantity => ((quantity * 1e-1) / 1e3d, MassMomentOfInertiaUnit.KilogramSquareMeter));
                    unitConverter.SetConversionFunction<MassMomentOfInertia>(MassMomentOfInertiaUnit.KilotonneSquareMeter, MassMomentOfInertiaUnit.KilogramSquareMeter, quantity => ((quantity * 1e-3) / 1e3d, MassMomentOfInertiaUnit.KilogramSquareMeter));
                    unitConverter.SetConversionFunction<MassMomentOfInertia>(MassMomentOfInertiaUnit.KilotonneSquareMilimeter, MassMomentOfInertiaUnit.KilogramSquareMeter, quantity => ((quantity * 1e3) / 1e3d, MassMomentOfInertiaUnit.KilogramSquareMeter));
                    unitConverter.SetConversionFunction<MassMomentOfInertia>(MassMomentOfInertiaUnit.MegatonneSquareCentimeter, MassMomentOfInertiaUnit.KilogramSquareMeter, quantity => ((quantity * 1e1) / 1e6d, MassMomentOfInertiaUnit.KilogramSquareMeter));
                    unitConverter.SetConversionFunction<MassMomentOfInertia>(MassMomentOfInertiaUnit.MegatonneSquareDecimeter, MassMomentOfInertiaUnit.KilogramSquareMeter, quantity => ((quantity * 1e-1) / 1e6d, MassMomentOfInertiaUnit.KilogramSquareMeter));
                    unitConverter.SetConversionFunction<MassMomentOfInertia>(MassMomentOfInertiaUnit.MegatonneSquareMeter, MassMomentOfInertiaUnit.KilogramSquareMeter, quantity => ((quantity * 1e-3) / 1e6d, MassMomentOfInertiaUnit.KilogramSquareMeter));
                    unitConverter.SetConversionFunction<MassMomentOfInertia>(MassMomentOfInertiaUnit.MegatonneSquareMilimeter, MassMomentOfInertiaUnit.KilogramSquareMeter, quantity => ((quantity * 1e3) / 1e6d, MassMomentOfInertiaUnit.KilogramSquareMeter));
                    unitConverter.SetConversionFunction<MassMomentOfInertia>(MassMomentOfInertiaUnit.MilligramSquareCentimeter, MassMomentOfInertiaUnit.KilogramSquareMeter, quantity => ((quantity * 1e7) / 1e-3d, MassMomentOfInertiaUnit.KilogramSquareMeter));
                    unitConverter.SetConversionFunction<MassMomentOfInertia>(MassMomentOfInertiaUnit.MilligramSquareDecimeter, MassMomentOfInertiaUnit.KilogramSquareMeter, quantity => ((quantity * 1e5) / 1e-3d, MassMomentOfInertiaUnit.KilogramSquareMeter));
                    unitConverter.SetConversionFunction<MassMomentOfInertia>(MassMomentOfInertiaUnit.MilligramSquareMeter, MassMomentOfInertiaUnit.KilogramSquareMeter, quantity => ((quantity * 1e3) / 1e-3d, MassMomentOfInertiaUnit.KilogramSquareMeter));
                    unitConverter.SetConversionFunction<MassMomentOfInertia>(MassMomentOfInertiaUnit.MilligramSquareMillimeter, MassMomentOfInertiaUnit.KilogramSquareMeter, quantity => ((quantity * 1e9) / 1e-3d, MassMomentOfInertiaUnit.KilogramSquareMeter));
                    unitConverter.SetConversionFunction<MassMomentOfInertia>(MassMomentOfInertiaUnit.PoundSquareFoot, MassMomentOfInertiaUnit.KilogramSquareMeter, quantity => (quantity / 4.21401101e-2, MassMomentOfInertiaUnit.KilogramSquareMeter));
                    unitConverter.SetConversionFunction<MassMomentOfInertia>(MassMomentOfInertiaUnit.PoundSquareInch, MassMomentOfInertiaUnit.KilogramSquareMeter, quantity => (quantity / 2.9263965e-4, MassMomentOfInertiaUnit.KilogramSquareMeter));
                    unitConverter.SetConversionFunction<MassMomentOfInertia>(MassMomentOfInertiaUnit.SlugSquareFoot, MassMomentOfInertiaUnit.KilogramSquareMeter, quantity => (quantity / 1.3558179619, MassMomentOfInertiaUnit.KilogramSquareMeter));
                    unitConverter.SetConversionFunction<MassMomentOfInertia>(MassMomentOfInertiaUnit.SlugSquareInch, MassMomentOfInertiaUnit.KilogramSquareMeter, quantity => (quantity / 9.41540242e-3, MassMomentOfInertiaUnit.KilogramSquareMeter));
                    unitConverter.SetConversionFunction<MassMomentOfInertia>(MassMomentOfInertiaUnit.TonneSquareCentimeter, MassMomentOfInertiaUnit.KilogramSquareMeter, quantity => (quantity * 1e1, MassMomentOfInertiaUnit.KilogramSquareMeter));
                    unitConverter.SetConversionFunction<MassMomentOfInertia>(MassMomentOfInertiaUnit.TonneSquareDecimeter, MassMomentOfInertiaUnit.KilogramSquareMeter, quantity => (quantity * 1e-1, MassMomentOfInertiaUnit.KilogramSquareMeter));
                    unitConverter.SetConversionFunction<MassMomentOfInertia>(MassMomentOfInertiaUnit.TonneSquareMeter, MassMomentOfInertiaUnit.KilogramSquareMeter, quantity => (quantity * 1e-3, MassMomentOfInertiaUnit.KilogramSquareMeter));
                    unitConverter.SetConversionFunction<MassMomentOfInertia>(MassMomentOfInertiaUnit.TonneSquareMilimeter, MassMomentOfInertiaUnit.KilogramSquareMeter, quantity => (quantity * 1e3, MassMomentOfInertiaUnit.KilogramSquareMeter));
        }
        ...
        public MassMomentOfInertia ToUnit(MassMomentOfInertiaUnit unit, UnitConverter unitConverter)
        {
            ...
            else if (unitConverter.TryGetConversionFunction<MassMomentOfInertia>(Unit, unit, out ConversionFunctionSameTypeDecimal conversionFunction))
            {
                // Direct conversion to requested unit found. Return the converted quantity.
                var c = conversionFunction(this.Value);
                return new MassMomentOfInertia(c.Item1, (MassMomentOfInertiaUnit)c.Item2);
            }
